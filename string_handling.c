...
/**
 * lexi_cmp - 2 strings lexicographic comparison
 * @first_str: The 1st string variable part of the comparison
 * @second_str: The 2nd string variable part of the comparison
 *
 * Return: For first_str < second_str, return -1;
 *         For first_str == second_str, return 0;
 *         For first_str > second_str, return 1
 */
